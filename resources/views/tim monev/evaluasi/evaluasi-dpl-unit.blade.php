        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Unit Bimbingan: {{ $dpl->dosen->user->nama ?? 'DPL' }}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('monev.evaluasi.index') }}">Evaluasi Unit</a></li>
                            <li class="breadcrumb-item active"><a href="{{ route('monev.evaluasi.dpl-units', $dpl->id) }}">Daftar Unit</a></li>
                        </ol>
                    </div>
                </div>
            </div>
