...
@section('title', 'Dashboard Monev') {{-- Judul tab browser --}}
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Dashboard Monev</h4>
                    {{-- Breadcrumb minimal --}}
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{-- Tulisan Utama --}}
                        <h1 class="text-center">Hello Monev!</h1>
                        <p class="text-center">Dashboard Anda berhasil dimuat.</p>

                        <hr> {{-- Pemisah --}}

                        {{-- Menampilkan data Email dan ID KKN jika ada --}}
                        <div class="text-center mt-3">
                            @isset($email)
                                <p class="text-muted mb-1">Email Anda: <strong>{{ $email }}</strong></p>
                            @else
                                <p class="text-danger mb-1"><em>(Data Email tidak ditemukan)</em></p>
                            @endisset
