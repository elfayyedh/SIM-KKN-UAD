                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Manajemen Proker</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-12 mb-3 mt-3">
                                <button class="btn btn-primary tambah-kegiatan" data-bs-toggle="modal"
                                    data-bs-target="#addKegiatan"><i class="fas fa-plus me-1"></i>Tambah kegiatan</button>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="p-1 align-top">
                                                    @foreach ($item->tanggalRencanaProker as $tanggal)
                                                        <ul>
                                                            <li class="p-0 formatTanggal">{{ $tanggal->tanggal }}</li>
                                                        </ul>
                                                    @endforeach
                                                </td>
                                                <td class="p-1 align-top">
                                                    ...
                                                    @php
                                                        $tanggalRencanaProker = implode(
                                                            ', ',
                                                            $item->tanggalRencanaProker->pluck('tanggal')->toArray(),
                                                        );
                                                    @endphp
                                                    <button class="btn btn-warning edit-kegiatan" data-bs-toggle="modal"
                                                        data-bs-target="#editKegiatanModal" data-id="{{ $item->id }}"
                                                        data-nama="{{ $item->nama }}"
                                                        data-frekuensi="{{ $item->frekuensi }}"
                                                        data-jkem="{{ $item->jkem }}"
                                                        data-total_jkem="{{ $item->total_jkem }}"
                                                        data-tanggal="{{ $tanggalRencanaProker }}">Edit</button>
                                                    <button class="btn btn-danger delete-kegiatan" data-bs-toggle="modal"
    ...
    <div class="modal fade" id="deleteKegiatanModal" aria-labelledby="deleteKegiatanModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center" id="deleteKegiatan">
