...
@section('title', 'Tambah Proker Individu | ' . $mahasiswa->userRole->user->nama)
@section('styles')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">TAMBAH PROKER INDIVIDU</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Manajemen Unit</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('proker.individu') }}">Proker individu</a>
                                </li>
                                <li class="breadcrumb-item active">Tambah proker individu</li>
                            </ol>
                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="program" name="program"
                                                        title="Pilih Program atau buat baru" class="proker w-100">
                                    ...
                                    <div class="tab-pane" id="tab_kegiatan">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" required data-flatpickr
                                                                    ...
                                                                    placeholder="Masukkan tanggal tanggal kegiatan"
                                        ...
                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                            <li class="previous"><a href="javascript: void(0);"
                                                    ...
                                                    Sebelumnya</a></li>
                                            <li class="next" ><a href="javascript: void(0);"
                                                    class="btn btn-primary next-berikutnya">Berikutnya <i
...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/pages/momentId.init.js') }}"></script>

    <script src="{{ asset('assets/js/init/mahasiswa/proker-create/getDataBidangProkerUnit.init.js') }}"></script>
    ...
    <script src="{{ asset('assets/js/init/mahasiswa/proker-individu/save-data.init.js') }}"></script>
