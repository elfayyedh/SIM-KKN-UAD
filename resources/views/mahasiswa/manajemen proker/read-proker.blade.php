...
@section('title', 'Proker Individu | ' . $mahasiswa->userRole->user->nama)
@section('styles')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">PROGRAM KERJA INDIVIDU</h4>
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <a href="{{ route('proker.create.individu') }}" class="btn btn-primary  waves-effect waves-light"><i
...
@section('pageScript')
    ...
    <script src="{{ asset('assets/js/init/mahasiswa/proker-individu/read-proker.init.js') }}"></script>
