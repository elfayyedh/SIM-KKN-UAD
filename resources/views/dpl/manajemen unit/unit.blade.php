...
@endsection
@section('title', 'Unit Bimbingan DPL | ' . ($dpl->userRole->user->nama ?? 'DPL'))
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4></h4>
                        <div id="tabel-unit-container">
                            <p class="text-center">Memuat data tabel...</p>
                        </div>
                    </div>
                </div>
            </div>
...
@section('pageScript')
    ...
    <script>
        $(document).ready(function() {
            $.get("{{ route('unit.getTable') }}", function(data) {
                $('#tabel-unit-container').html(data);
