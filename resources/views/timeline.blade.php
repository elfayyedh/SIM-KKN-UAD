                                                        ...
                                                        <div class="timeline-box">
                                                            ...
                                                            <div class="event-content">
                                                                <div class="timeline-text">
                                                                    ...
                                                                    <p class="mb-0 mt-2 pt-1 text-muted">Perspitis
                                                                        unde omnis it voluptatem
                                                            ...
                                                            <div class="event-content">
                                                                <div class="timeline-text">
                                                                    ...
                                                                    <p class="mb-0 mt-2 pt-1 text-muted">At vero eos
                                                                        ...
                                                                        dolores chooses to enjoy pleasure that has
                                                                        no annoying.</p>
                                                ...
                                                <div class="row timeline-right">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="timeline-box">
                                                            ...
                                                            <div class="event-content">
                                                                <div class="timeline-text">
                                                                    <h3 class="font-size-18">Timeline Event Three
                                                                    </h3>
                                                                    <p class="mb-0 mt-2 pt-1 text-muted">Vivamus
                                                                        ultrices massa turna interdum
                                                                        eu. Pellentesque habitant morbi tristique
                                                                        eget justo sit amet est
                                                                        varius mollis et quis nisi. Suspendisse
                                                                        potenti. senectus
                                                ...
                                                <div class="row timeline-left">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="timeline-box">
                                                            ...
                                                            <div class="event-content">
                                                                <div class="timeline-text">
                                                                    <h3 class="font-size-18">Timeline Event Four
                                                                    </h3>
                                                                    <p class="mb-0 mt-2 pt-1 text-muted">Printing
                                                                        and typesetting industry. been
                                                ...
                                                <div class="row timeline-right">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="timeline-box">
                                                            ...
                                                            <div class="event-content">
                                                                <div class="timeline-text">
                                                                    <h3 class="font-size-18">Timeline Event Five
                                                                    </h3>
                                                                    ...
                                                                    <p class="mb-0 mt-2 pt-1 text-muted">Excepturi,
                                                                        ...
                                                                        Odit, itaque, deserunt corporis vero ipsum
                                                                        nisi repellat ... <a href="#">Read more</a>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="event-content">
                                                                <div class="timeline-text">
                                                                    ...
                                                                    <p class="mb-0 mt-2 pt-1 text-muted">Suspendisse
                                                                        ...
                                                                        pellentesque sapien, vel tempor arcu dolor
                                                                        ut est. Nam ac felis id
                                                                        mauris fermentum
