(function ($) {
    ...
    $(".formatTanggal").each(function () {
        var tanggalAsli = $(this).text();
        var tanggalObj = new Date(tanggalAsli);
        var tanggalFormatIndonesia = tanggalObj.toLocaleDateString("id-ID", {
            weekday: "long",
            year: "numeric",
            month: "long",
            day: "numeric",
        });
        $(this).text(tanggalFormatIndonesia);
    });
