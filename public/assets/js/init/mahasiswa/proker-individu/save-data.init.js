$(document).ready(function () {
    ...
    <h5>Data proker berhasil disimpan</h5>
    `;
    ...
    function handleError() {
        ...
        if (tempat == "") {
            $("#error_tempat").text("*Tempat harus diisi");
            valid = false;
        } else {
            $("#error_tempat").text("*");
        }
        if (sasaran == "") {
            $("#error_sasaran").text("*Sasaran harus diisi");
            valid = false;
        } else {
            $("#error_sasaran").text("*");
        }
    ...
    $("#btn-confirm").on("click", function () {
        ...
        $.ajax({
            url: "/proker/individu/store", // Replace with your endpoint URL
            type: "POST",
            data: {
            ...
            success: function (response) {
                ...
                modal_footer.html(
                    `<a href="/proker/individu" class="btn btn-primary">Kembali</a>`
                );
            },
