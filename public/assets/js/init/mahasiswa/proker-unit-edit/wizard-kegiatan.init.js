$(document).ready(function () {
    ...
    let index = parseInt($("#jumlah_kegiatan").val()) + 1;
        ...
        <div class="row border kegiatan-row pt-3 mb-3">
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-12" id="button-hapus">
    ...
    function cekKegiatanCount() {
        const kegiatanCount = $(".kegiatan-row").length;

        $(".kegiatan-row").each(function () {
            if (kegiatanCount > 1) {
                $(this).find("#button-hapus").html(btn_hapus);
            } else {
                $(this).find("#button-hapus").html("");
            }
        });
    }
