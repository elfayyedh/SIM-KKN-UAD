...
!(function (root, factory) {
        ...
        (Sifter.prototype.getSortFunction = function (search, options) {
            ...
            if (sort)
                for (i = 0, n = sort.length; i < n; i++)
                    (!search.query && "$score" === sort[i].field) ||
                        fields.push(sort[i]);
            if (search.query) {
    ...
    var cmp = function (a, b) {
        ...
        is_array =
            ...
            function (object) {
                return (
                    "[object Array]" === Object.prototype.toString.call(object)
                );
            },
        DIACRITICS = {
    ...
    (function (root, factory) {
        ...
        var MicroPlugin = {
                mixin: function (Interface) {
                    (Interface.plugins = {}),
                        (Interface.prototype.initializePlugins = function (
                            plugins
                        ) {
                            var i,
                                n,
    ...
    (function (root, factory) {
                    ...
                    : ((this._events = this._events || {}),
                      void (
                          ...
                          this._events[event].splice(
                              this._events[event].indexOf(fct),
                              1
                          )
                      ));
            },
        ...
        function getSelection(input) {
            ...
            return (
                void 0 === input
                    ? console.warn(
                          "WARN getSelection cannot locate input control"
                      )
            ...
            Selectize = function ($input, settings) {
                ...
                if (
                    ...
                    $.extend(this, {
                        ...
                        tagType:
                            "select" === input.tagName.toLowerCase() ? 1 : 2,
                        rtl: /rtl/i.test(dir),
        ...
        return (
            ...
            $.extend(Selectize.prototype, {
                setup: function () {
                    ...
                    (inputId = $input.attr("id")) &&
                        ...
                        !self.settings.splitOn &&
                            ...
                            ((delimiterEscaped =
                                self.settings.delimiter.replace(
                                    /[-\/\\^$*+?.()|[\]{}]/g,
                                    "\\$&"
                                )),
                        ...
                        selector.on(
                            ...
                            "[data-selectable]",
                            function () {
                                return self.onOptionHover.apply(
                                    self,
                                    arguments
                                );
                            }
                        ...
                        selector.on(
                            ...
                            "[data-selectable]",
                            function () {
                                return self.onOptionSelect.apply(
                                    self,
                                    arguments
                                );
                            }
                        ...
                        ($parent = $control).on(event, selector, function (e) {
                            ...
                            return (
                                (e.currentTarget = child), fn.apply(this, [e])
                            );
                        }),
                        ...
                        $document.on("keydown" + eventNS, function (e) {
                            (self.isCmdDown =
                                e[IS_MAC ? "metaKey" : "ctrlKey"]),
                                (self.isCtrlDown =
                                    e[IS_MAC ? "altKey" : "ctrlKey"]),
                ...
                onFocus: function (e) {
                    ...
                    if (this.isDisabled)
                        return this.blur(), e && e.preventDefault(), !1;
                    this.ignoreFocus ||
                        ((this.isFocused = !0),
                        "focus" === this.settings.preload &&
                            this.onSearchChange(""),
                ...
                onBlur: function (deactivate, dest) {
                    ...
                    if (
                        self.isFocused &&
                        ((self.isFocused = !1), !self.ignoreFocus)
                    ) {
                        if (
                            !self.ignoreBlur &&
                ...
                load: function (fn) {
                    var self = this,
                        $wrapper = self.$wrapper.addClass(
                            self.settings.loadingClass
                        );
                    self.loading++,
                        fn.apply(self, [
                            function (results) {
                ...
                setActiveOption: function (scroll_bottom, scroll, animate) {
                    ...
                    this.$activeOption &&
                        ...
                        (scroll_bottom = $(scroll_bottom)).length &&
                            ...
                            (!scroll && isset(scroll)) ||
                                ((height_menu =
                                    this.$dropdown_content.height()),
                                (height_item = this.$activeOption.outerHeight(
                                    !0
                                )),
                                (scroll =
                ...
                search: function (query) {
                    ...
                    if (
                        settings.score &&
                        "function" !=
                            typeof (calculateScore = this.settings.score.apply(
                                this,
                                [query]
                            ))
                    )
                ...
                refreshOptions: function (triggerDropdown) {
                    ...
                    for (
                        ...
                        for (
                            option = self.options[results.items[i].id],
                                ...
                                optgroup =
                                    option[self.settings.optgroupField] || "",
                                j = 0,
                                k =
                                    (optgroups = $.isArray(optgroup)
                                        ? optgroup
                                        ...
                                        highlight = function (node) {
                                            ...
                                            if (3 === node.nodeType) {
                                                var spannode,
                                                    middleclone,
                                                    middlebit =
                                                        node.data.search(regex);
                                                0 <= middlebit &&
                                                    0 < node.data.length &&
                                                    ((middleclone =
                                                        node.data.match(regex)),
                                                    ((spannode =
                                                        document.createElement(
                                                            "span"
                                                        )).className =
                    ...
                    (has_create_option = self.canCreate(query)) &&
                        ...
                        (self.hasOptions =
                            0 < results.items.length || has_create_option),
                        self.hasOptions
                            ? (0 < results.items.length
                                  ? (($active_before =
                                    ...
                                    $active_before.length
                                        ...
                                        : "single" === self.settings.mode &&
                                          self.items.length &&
                                          ($active = self.getOption(
                                              self.items[0]
                                          )),
                                    ($active && $active.length) ||
                                        ($active =
                                            $create &&
                                            !self.settings.addPrecedence
                                                ? self.getAdjacentOption(
                                                      $create,
                                                      1
                                                  )
                ...
                updateOption: function ($item, $item_new) {
                    ...
                    if (
                        (($item = hash_key($item)),
                        (value_new = hash_key(
                            $item_new[this.settings.valueField]
                        )),
                        ...
                        (cache_options = this.options[$item].$order),
                            value_new !== $item &&
                                ...
                                -1 !==
                                    (cache_items = this.items.indexOf($item)) &&
                                    this.items.splice(
                                        cache_items,
                                        1,
                                        value_new
                ...
                getElementWithTextContent: function (
                    textContent,
                    ignoreCase,
                    $els
                ) {
                ...
                getFirstItemMatchedByTextContent: function (
                    textContent,
                    ignoreCase
                ) {
                    return (
                ...
                removeItem: function (value, silent) {
                    var i,
                        idx,
                        $item =
                            value instanceof $ ? value : this.getItem(value);
                ...
                createItem: function (output, triggerDropdown) {
                    ...
                    if (
                        ("function" != typeof callback &&
                            (callback = function () {}),
                        "boolean" != typeof triggerDropdown &&
                            (triggerDropdown = !0),
                        ...
                        setup =
                            "function" == typeof self.settings.create
                                ...
                                : function (input) {
                                      var data = {};
                                      return (
                                          (data[self.settings.labelField] =
                                              input),
                                          (data[self.settings.valueField] =
                                              input),
                                          data
                                      );
                                  },
                ...
                updateOriginalInput: function (opts) {
                    ...
                    if (((opts = opts || {}), 1 === this.tagType)) {
                        for (
                            options = [], i = 0, n = this.items.length;
                            i < n;
                            i++
                        )
                            (label =
                                this.options[this.items[i]][
                ...
                deleteSelection: function (e) {
                    ...
                    if (
                        ...
                        for (
                            ...
                            values.push(
                                $(this.$activeItems[i]).attr("data-value")
                            );
                    ...
                    if (
                        ...
                        return !1;
                    for (
                        void 0 !== caret && this.setCaret(caret);
                        values.length;
                ...
                advanceSelection: function (direction, e) {
                    ...
                    0 !== direction &&
                        ...
                        this.isFocused && !this.isInputHidden
                            ...
                            : (idx = this.$control.children(".active:" + idx))
                                  .length &&
                              ((idx = this.$control
                                  .children(":not(input)")
                                  .index(idx)),
                ...
                setCaret: function (i) {
                    if (
                        ...
                        for (
                            var $child,
                                $children =
                                    this.$control.children(":not(input)"),
                                j = 0,
                                n = $children.length;
                            j < n;
                            j++
                ...
                render: function (templateName, data) {
                    ...
                    return (cache =
                        ...
                        : ((html = $(
                          ...
                          "option" === templateName ||
                          "option_create" === templateName
                              ? data[this.settings.disabledField] ||
                                html.attr("data-selectable", "")
                              : "optgroup" === templateName &&
                                ((id =
                                    data[this.settings.optgroupValueField] ||
                                    ""),
            ...
            ($.fn.selectize = function (settings_user) {
                function init_select($input, settings_element) {
                    function readData(data) {
                        return "string" ==
                            typeof (data = attr_data && data.attr(attr_data)) &&
                            data.length
                            ? JSON.parse(data)
                            : null;
                    }
                    ...
                    var i,
                        ...
                        optionsMap = {};
                    for (
                        settings_element.maxItems = $input.attr("multiple")
                            ? null
                            : 1,
                            i = 0,
                            ...
                            ? (function ($optgroup) {
                                  ...
                                  for (
                                      (id = ($optgroup = $($optgroup)).attr(
                                          ...
                                          (optgroup[field_disabled] =
                                              $optgroup.prop("disabled")),
                                          settings_element.optgroups.push(
                                              optgroup
                                          )),
                                          i = 0,
                                          n = ($options = $(
            ...
            Selectize.define("auto_select_on_type", function (options) {
                ...
                self.onBlur =
                    ...
                    function (e) {
                        var $matchedItem =
                            self.getFirstItemMatchedByTextContent(
                                self.lastValue,
                                !0
                            );
                        return (
                ...
                function equalizeSizes() {
                    ...
                    if (n && self.$dropdown_content.width()) {
                        ...
                        options.equalizeWidth &&
                            ((width_parent =
                                self.$dropdown_content.innerWidth() -
                                getScrollbarWidth()),
                            (width_last = Math.round(width_parent / n)),
                            $optgroups.css({ width: width_last }),
                            1 < n &&
                                ((width_last =
                                    width_parent - width_last * (n - 1)),
                                $optgroups
                                    .eq(n - 1)
                                    .css({ width: width_last })));
                    }
                }
